...
public:
	...
	const bool isChallengedPhoney() const;
	void setIsChallengedPhoney(bool isChallengedPhoney);

	const int scoreAddition() const;
...
inline const bool Move::isChallengedPhoney() const
{
...
inline const int Move::scoreAddition() const
{
